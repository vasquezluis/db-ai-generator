...
export const generateTableResponse = async ({
	...
	;(async () => {
		const { partialObjectStream } = await streamObject({
			...
			system:
				'Generas estructuras MySQL que ayuden al usuario con su idea de proyecto el código generado debe cumplir con la estructura para ser usado junto a react-markdown y react-syntax-highlighter, incluye comentarios si es necesario. Crea todo en español.',
			schema: tableSchema,
